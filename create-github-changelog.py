...
if __name__ == '__main__':
    ...
    if modified:
        try:
            changelogfilename = sys.argv[2]
        except IndexError:
            print('No filename specified, using latest-changelog.md')
            changelogfilename = 'latest-changelog.md'
        print('Writing modified changelog.')
        with open(changelogfilename, 'w', encoding='utf-8') as logfile:
